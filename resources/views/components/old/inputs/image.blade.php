@if(isset($options))
    @php
        $_X = array_merge([
            ...
            'input_size'  => 'col-lg-8',
            'changable'   => true,
            'change_string' => __('admin::strings.change'),
            'cancel_string' => __('admin::strings.change'),
                ...
                <div class="kt-avatar kt-avatar--outline kt-avatar--{!! $_X['shape'] !!}">
                    ...
                    @if($_X['changable'])
                        <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="{!! $_X['change_string'] !!}">
                            <i class="fa fa-pen"></i>
                            <input {!! $_X['id'] ? 'id="' . $_X['id'] . '"' : '' !!} type='file' name="{!! $_X['name'] !!}" class="{!! $_X['class'] !!}" {!! $_X['attr'] !!} accept="image/x-png,image/jpg,image/jpeg,image/png"/>
                        </label>
